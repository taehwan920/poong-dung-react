...
Node.js/Express.js를 이용해 RESTful API를 구현하는 법을 배웠습니다.   
   
  ### Front-end   
React JS의 state 생명주기를 활용하여 클라이언트 단을 구현할 줄 안다.   
Back-end에서 만든 RESTful API에서 쿼리 요청을 통해 데이터를 받아오는 법을 배웠습니다.   
...
4. Node.js/Express : RESTful API를 router형식으로 만들기 위해 사용했습니다.   
### Front-end   
